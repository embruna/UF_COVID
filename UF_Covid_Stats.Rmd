...
<!-- \newpage -->
<!-- ```{r student, message=FALSE, warning=FALSE, echo=FALSE} -->
<!-- source("./code/student_daily.R") -->
<!-- student_daily(uf.data) -->
<!-- # s[1] -->
<!-- # s[2] -->
<!-- ``` -->

<!-- \blandscape -->
<!-- ```{r daily.pos.fig, message=FALSE, warning=FALSE, echo=FALSE,fig.height = 7,fig.width=10} -->
...
<!-- ```{r daily.n.fig,message=FALSE,warning=FALSE,echo=FALSE,fig.height = 7,fig.width=10} -->
...
<!-- ```{r cumulative.pos.fig, message=FALSE,warning=FALSE,echo=FALSE,fig.height = 7,fig.width=10} -->
